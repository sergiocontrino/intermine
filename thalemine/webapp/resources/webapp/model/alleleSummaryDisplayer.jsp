...
<c:set var="alleleClassTooltip" value="Allele Type: A classification of mutant alleles based upon the molecular function of the altered gene product.
...
<c:set var="inheritanceTypeTooltip" value="Inheritance Type: The phenotype effect of a given allele in reference to another allele with respect to a particular trait.
