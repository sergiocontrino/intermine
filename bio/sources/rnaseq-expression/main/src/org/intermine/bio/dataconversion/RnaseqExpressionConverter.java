...
public class RnaseqExpressionConverter extends BioFileConverter
{
    ...
    private static final String TAX_ID = "344734";
    private static final String DATASET_TITLE = "LIB expression";
    private static final String DATASOURCE_NAME = "Aber";

    private static final String EXP_DATASET = "LIB counts";
...
//    private static final String CATEGORY = "RNA-Seq";
    ...
    public void process(Reader reader) throws Exception {
        ...
        if (currentFile.getName().contains("expression")) {
        ...
        while (tsvIter.hasNext()) {
            ...
            if (lineNumber == 0) {
                ...
                for (int i = 1; i < totHeaders; i++) {
                    String col = headers[i].replace(REDUN, "");
    ...
    private Item createRNASeqExpression(String score, String type) throws ObjectStoreException {
        ...
        expression.setAttribute("unit", UNIT);
