...
public class CreateFlankingRegions
{
    ...
    private static double[] distances = new double[] {0.5, 1, 3};
    ...
    public void createFlankingFeatures() throws ObjectStoreException {
        ...
        dataSet.setName("ThaleMine gene flanking regions");
        dataSet.setDescription("Gene flanking regions generated by ThaleMine");
